...
export const funnelHeroCopy: Record<Lang, { headline: string; supporting: string; trust: string }> = {
  sv: {
    ...
    supporting:
      "Ett enkelt blodtest visar din uppmätta balans mellan omega-6 och omega-3 svart på vitt, baserat på dina egna värden.",
  ...
  en: {
    ...
    supporting:
      "A simple blood test gives you a personal measurement of your omega-6 to omega-3 balance, based on your own values.",
    trust: "A simple test. A clear result.",
  },
  no: {
    headline: "Få et tydelig mål på omega-balansen din",
    supporting:
      "En enkel blodtest viser den målte balansen mellom omega-6 og omega-3, basert på dine egne verdier.",
    trust: "En enkel test. Et tydelig resultat.",
  },
  da: {
    headline: "Få et tydeligt mål for din omega-balance",
    supporting:
      "En enkel blodtest viser din målte balance mellem omega-6 og omega-3, baseret på dine egne værdier.",
    trust: "En enkel test. Et tydeligt resultat.",
  },
  fi: {
    headline: "Näe missä omega-tasapainosi oikeasti on",
    supporting:
      "Yksinkertainen veritesti antaa henkilökohtaisen mittauksen omega-6:n ja omega-3:n tasapainosta omien arvojesi perusteella.",
    trust: "Yksinkertainen testi. Selkeä tulos.",
  },
  de: {
    headline: "Klare Messung deiner Omega-Balance",
    supporting:
      "Ein einfacher Bluttest zeigt dein gemessenes Verhältnis zwischen Omega-6 und Omega-3 auf Basis deiner eigenen Werte.",
    trust: "Ein klarer Ablauf. Ein nachvollziehbares Ergebnis.",
  },
  fr: {
    headline: "Comprenez clairement votre équilibre oméga",
    supporting:
      "Un simple test sanguin vous donne une mesure personnelle de votre équilibre entre oméga-6 et oméga-3, à partir de vos propres valeurs.",
    trust: "Une démarche simple. Un résultat clair.",
  },
  it: {
    headline: "Capisci con chiarezza il tuo equilibrio Omega",
    supporting:
      "Un semplice test del sangue ti dà una misurazione personale del tuo equilibrio tra Omega-6 e Omega-3, basata sui tuoi valori.",
...
> = {
  ...
  en: {
    ...
    body:
      "It is easy to go by diet, habits, or guesswork. Without a measurement result, it is hard to know where your balance actually stands.",
  ...
  no: {
    ...
    body:
      "Det er lett å gå ut fra kosthold, vaner eller følelse. Uten et måleresultat er det vanskelig å vite hvor balansen faktisk ligger.",
  ...
  da: {
    ...
    body:
      "Det er let at gå ud fra kost, vaner eller fornemmelse. Uden et måleresultat er det svært at vide, hvor balancen faktisk ligger.",
    ...
    body:
      "On helppo nojata ruokavalioon, tapoihin tai tuntemukseen. Ilman mittaustulosta on kuitenkin vaikea tietää, missä tasapaino oikeasti on.",
  ...
  de: {
    ...
    body:
      "Oft orientiert man sich an Ernährung oder Gewohnheiten. Ohne Messergebnis ist es jedoch schwer nachzuvollziehen, wie das Verhältnis tatsächlich aussieht.",
  ...
  fr: {
    ...
    body:
      "Il est facile de se fier à l'alimentation, aux habitudes ou au ressenti. Sans résultat de mesure, il est difficile de savoir où se situe réellement l'équilibre.",
  ...
  it: {
    ...
    body:
      "È facile basarsi su alimentazione, abitudini o sensazioni. Senza un risultato di misurazione è difficile capire dove si trovi davvero l'equilibrio.",
