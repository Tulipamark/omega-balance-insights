...
export const fr: Copy = {
  hero: {
    ...
    primaryCta: "Commandez votre BalanceTest ici",
  ...
  abTesting: {
    ...
    ctas: ["Commandez votre BalanceTest ici", "Découvrir mon ratio", "Recevoir mon analyse personnalisée"],
  },
  sticky: {
  ...
  partner: {
    ...
    heroTitle: "Développez une activité partenaire autour de la santé mesurable",
    heroBody: "Aidez davantage de personnes à comprendre leur équilibre en oméga tout en construisant une activité fondée sur une demande récurrente, de meilleures marges et un potentiel durable.",
    heroPrimaryCta: "Signaler mon intérêt",
    heroSecondaryCta: "Voir comment le modèle fonctionne",
    highlights: [
      { title: "Un produit clair à présenter", description: "Un test scientifique à domicile est plus facile à expliquer que des promesses bien-être vagues. Il donne aux gens quelque chose de concret à comprendre et à utiliser." },
      { title: "Un modèle avec de meilleures marges", description: "Lorsque les intermédiaires inutiles sont supprimés, une plus grande partie de la valeur peut rester dans le modèle au lieu de se perdre dans plusieurs couches externes." },
      { title: "Une activité qui peut grandir à l'international", description: "L'opportunité n'est pas limitée à un seul marché local. Cela crée davantage d'espace pour croître avec le temps." },
    ],
    economicsTitle: "Pourquoi le modèle peut-il créer de la place pour les revenus partenaires ?",
    economicsBody: "Dans une chaîne traditionnelle, chaque étape ajoute du coût et prend sa part. Lorsque moins d'acteurs se partagent la même valeur, l'économie devient plus efficace.",
    economicsSteps: [
      { label: "Laboratoire / production", value: "179 kr" },
      { label: "Marque / import", value: "349 kr" },
      { label: "Grossiste", value: "699 kr" },
      { label: "Magasin", value: "1299 kr" },
    ],
    economicsCalloutTitle: "L'idée n'est pas le battage. L'idée est une chaîne de valeur plus simple.",
    economicsCalloutBody: "Un chemin plus court entre le produit et le client signifie que moins de valeur se perd dans des couches externes. Cela crée plus d'espace pour l'entreprise comme pour les futurs partenaires.",
    reasonsTitle: "Qu'est-ce qui rend un modèle partenaire intéressant à construire ?",
    reasonsBody: "Selon nous, les meilleures opportunités partenaires reposent sur la stabilité, une demande récurrente, un bon timing marché et une portée internationale.",
    reasons: [
      { title: "Un historique démontré", description: "Une entreprise sérieuse doit reposer sur quelque chose de réel : de l'expérience, des résultats et un modèle qui a déjà montré qu'il fonctionne." },
      { title: "Des produits auxquels les gens reviennent", description: "Une demande récurrente offre une base bien plus solide que des achats ponctuels. Cela facilite la création d'élan dans le temps." },
      { title: "Une catégorie de plus en plus pertinente", description: "La santé basée sur les tests et l'intérêt pour les biomarqueurs personnels continuent de progresser. Le sujet est donc plus actuel aujourd'hui que dans de nombreuses anciennes catégories." },
      { title: "Un potentiel international", description: "Un modèle partenaire devient plus intéressant lorsqu'il n'est pas limité à un seul pays. Une portée plus large signifie un potentiel plus large à long terme." },
    ],
    formTitle: "Envie de devenir partenaire ?",
    formBody: "Laissez vos coordonnées et un court message sur votre parcours ou votre intérêt, et nous reviendrons vers vous avec la prochaine étape.",
    formName: "Votre nom",
    formEmail: "Votre e-mail",
    formPhone: "Numéro de téléphone",
    formCompany: "Entreprise ou équipe (facultatif)",
    formMessage: "Parlez-nous brièvement de votre parcours ou de votre intérêt",
    formSubmit: "Envoyer une demande partenaire",
    formSuccessTitle: "Merci pour votre intérêt",
    formSuccessBody: "Nous avons bien reçu votre message et reviendrons vers vous prochainement avec la prochaine étape.",
  },
  footer: {
  ...
  cookie: {
    ...
    message: "Nous utilisons le stockage local et des cookies necessaires pour les liens de recommandation, les sessions et les fonctions de base. La mesure optionnelle du trafic ne demarre qu'apres votre consentement.",
    necessary: "Necessaire pour les referrals, les sessions et la fonction de base.",
    optional: "Optionnel pour les pages vues et l'amelioration des parcours.",
    accept: "Accepter la mesure optionnelle",
    decline: "Uniquement le necessaire",
  },
};
