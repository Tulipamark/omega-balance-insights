...
export const fr: Copy = {
  ...
  partner: {
    ...
    heroTitle: "Développez une activité partenaire autour d'un concept de santé fondé sur le test",
    heroBody: "Pour celles et ceux qui croient à la mesure, à la clarté et à la construction dans la durée. Nous pensons que la santé fondée sur le test va gagner en importance dans les années à venir, et que ceux qui construisent sérieusement dès maintenant seront mieux placés ensuite.",
    heroPrimaryCta: "Postuler comme partenaire",
    heroSecondaryCta: "Voir comment cela fonctionne",
    highlights: [
      { title: "Un concept concret que l'on peut assumer", description: "Une offre fondée sur le test est plus facile à expliquer que des promesses santé vagues. Le client part de quelque chose de mesurable." },
      { title: "Une base plus solide pour des clients récurrents", description: "Lorsque les personnes suivent leurs résultats dans le temps, la relation client devient plus durable que dans des catégories purement ponctuelles." },
      { title: "Pertinent dans un marché en maturation", description: "L'intérêt pour les biomarqueurs, le suivi et des décisions santé plus factuelles progresse. Cela rend la catégorie intéressante sur un horizon de 3 à 5 ans." },
    ],
    economicsTitle: "Pourquoi le modèle peut-il créer de la place pour les revenus partenaires ?",
    economicsBody: "Dans les chaînes traditionnelles, la valeur transite par de nombreuses couches externes. Moins d'intervenants partagent la même valeur, plus peut rester dans le modèle.",
    economicsSteps: [
    ...
    economicsCalloutTitle: "L'idée n'est pas du battage. L'idée est une chaîne de valeur plus simple.",
    economicsCalloutBody: "Un parcours plus court du produit au client signifie que moins de valeur se perd dans les couches externes. Cela crée plus d'espace à la fois pour l'entreprise et pour les futurs partenaires.",
    reasonsTitle: "Qu'est-ce qui rend un modèle partenaire intéressant à construire ?",
    reasonsBody: "Selon nous, les meilleures opportunités partenaires reposent sur quatre éléments : une demande réelle, des clients fidèles, une différenciation claire et la capacité à grandir dans le temps.",
    reasons: [
      { title: "Produit réel, besoin réel", description: "La santé mesurable est plus facile à communiquer quand le produit offre une réponse concrète, pas seulement une sensation." },
      { title: "Des clients qui peuvent revenir", description: "Un modèle plus fort ne s'appuie pas uniquement sur les premiers achats, mais aussi sur le suivi, l'amélioration et les ventes répétées." },
      { title: "Bon timing de marché", description: "L'intérêt pour les biomarqueurs, la santé personnelle et les décisions basées sur les données augmente. Cela rend la catégorie plus pertinente que de nombreux produits traditionnels." },
      { title: "Pas limité à un petit marché", description: "Quand le modèle peut fonctionner dans plusieurs pays et réseaux, le potentiel à long terme augmente pour le bon type de partenaire." },
    ],
