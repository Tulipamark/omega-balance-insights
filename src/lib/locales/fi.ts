...
export const fi: Copy = {
  ...
  partner: {
    ...
    heroTitle: "Rakenna partneriliiketoimintaa testipohjaisen terveyskonseptin ympärille",
    heroBody: "Sinulle, joka uskot mittaamiseen, selkeyteen ja pitkäjänteisyyteen. Uskomme, että testipohjainen terveys tulee olemaan yhä relevantimpaa tulevina vuosina, ja että vakavasti nyt rakentava on myöhemmin vahvemmassa asemassa.",
    heroPrimaryCta: "Hae partneriksi",
    heroSecondaryCta: "Katso miten se toimii",
    highlights: [
      { title: "Konkreettinen konsepti, jonka takana voi seistä", description: "Testipohjainen tarjous on helpompi selittää kuin epämääräiset hyvinvointilupaukset. Asiakas saa jotain mitattavaa, josta lähteä liikkeelle." },
      { title: "Parempi perusta toistuvalle asiakkuudelle", description: "Kun ihmiset seuraavat tuloksiaan ajan myötä, asiakassuhteesta tulee pitkäjänteisempi kuin kertaluonteisissa kategorioissa." },
      { title: "Relevantti kypsyvässä markkinassa", description: "Kiinnostus biomarkkereihin, seurantaan ja faktapohjaisempiin terveyspäätöksiin kasvaa. Siksi kategoriassa on kiinnostavaa potentiaalia 3–5 vuoden tähtäimellä." },
    ],
    economicsTitle: "Miksi malli voi luoda tilaa partnerituloille?",
    economicsBody: "Perinteisissä ketjuissa arvo kulkee useiden ulkoisten portaiden kautta. Kun harvempi toimija jakaa saman arvon, enemmän voi jäädä malliin.",
    economicsSteps: [
    ...
    economicsCalloutTitle: "Piste ei ole hype. Piste on yksinkertaisempi arvoketju.",
    economicsCalloutBody: "Lyhyempi matka tuotteesta asiakkaalle tarkoittaa, että vähemmän arvoa katoaa ulkoisiin portaasiin. Se luo parempaa tilaa sekä yritykselle että tuleville partnereille.",
    reasonsTitle: "Mikä tekee partnerimallista rakentamisen arvoisen?",
    reasonsBody: "Uskomme, että vahvimmat partnerimahdollisuudet perustuvat neljään asiaan: varmaan kysyntään, toistuviin asiakkaisiin, selkeään erottautumiseen ja mahdollisuuteen kasvaa ajan myötä.",
    reasons: [
      { title: "Varmaa tuote, varmaa tarve", description: "Mitattavaa terveyttä on helpompi kertoa, kun tuote antaa asiakkaalle konkreettisen vastauksen, ei vain tunteen." },
      { title: "Asiakkaat, jotka voivat palata", description: "Malli vahvistuu, kun se ei perustu vain ensimmäisiin ostoihin vaan myös seurantaan, parantamiseen ja uusintaostoihin." },
      { title: "Oikea aika", description: "Kiinnostus biomarkkereihin, henkilökohtaiseen terveyteen ja datapohjaisia päätöksiin kasvaa. Siksi kategoria on relevantimpi kuin monet perinteiset terveystuotteet." },
      { title: "Ei rajoitettu pieneen markkinaan", description: "Kun malli voi toimia useissa maissa ja verkostoissa, kasvaa pitkän aikavälin potentiaali oikeanlaiselle partnerille." },
    ],
