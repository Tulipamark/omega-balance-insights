    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-20">
          <div className="container">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="mx-auto grid max-w-5xl gap-5 md:grid-cols-3">
              {benefits.map((b, i) => (
                <motion.div key={i} variants={fadeUp} custom={i} className="rounded-2xl border border-border bg-card p-6 shadow-sm transition-shadow">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent/70 text-accent-foreground">
        ...
        <ValueFlowSection partner={tr.partner} />
        ...
        <section className="py-20">
          <div className="container">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="mx-auto max-w-md">
              ...
              {submitted ? (
                <motion.div variants={fadeUp} custom={1} className="mt-8 rounded-2xl border border-primary/20 bg-accent p-8 text-center">
                  <p className="text-lg font-semibold text-accent-foreground">{tr.partner.success}</p>
                </motion.div>
              ) : (
                <motion.form variants={fadeUp} custom={1} onSubmit={handleSubmit} className="mt-8 rounded-2xl border border-border bg-card p-6 shadow-sm space-y-4">
