...
omegaBalanceV4Content.ar = {
  hero: {
    eyebrow: "OmegaBalance",
    title: "افهم توازن الأوميغا لديك بطريقة بسيطة",
    body: "هذه الصفحة تشرح لك بالعربية كيف يعمل اختبار أوميغا المنزلي، وما الذي يمكن أن يوضحه عن توازن أوميغا-6 وأوميغا-3 في جسمك. الهدف أن تفهم الخطوة قبل أن تقرر.",
    primaryCta: "المتابعة إلى الاختبار",
    ...
    trustRow: [
      ...
      { text: "شرح واضح للناطقين بالعربية في السويد", verification: "verified" },
    ],
    ...
    ratioCta: "المتابعة إلى الاختبار",
  },
  normalizing: {
    body: {
      text: "كثيرون لا يشعرون بأي شيء واضح في البداية. لذلك من السهل الاعتماد على التخمين أو النصائح العامة. القياس يعطيك نقطة بداية أوضح، من دون تخويف أو وعود كبيرة.",
      verification: "verified",
    },
  },
  markers: {
    eyebrow: "ما الذي يقيسه الاختبار",
    title: "أرقام تساعدك على فهم الصورة",
    body: "التقرير لا يعطيك رقما واحدا فقط. بل يعرض عدة مؤشرات تساعدك على فهم العلاقة بين الأحماض الدهنية في الدم.",
    items: [
      { title: "توازن أوميغا-6:3", body: { text: "يوضح العلاقة بين أوميغا-6 وأوميغا-3 في الدم.", verification: "verified" } },
      { title: "مؤشر أوميغا-3", body: { text: "يعطي صورة أوضح عن كمية أوميغا-3 في أغشية الخلايا.", verification: "required" } },
      { title: "قيمة الحماية", body: { text: "قيمة موجودة في التقرير وتساعد على قراءة النتيجة ضمن سياق أوسع.", verification: "required" } },
      { title: "مرونة غشاء الخلية", body: { text: "تصف جزءا من تركيب أغشية الخلايا كما يظهر في نموذج التقرير.", verification: "required" } },
      { title: "القوة الذهنية", body: { text: "اسم يظهر في التقرير. لا نستخدمه كوعد طبي أو كتشخيص.", verification: "required" } },
      { title: "مؤشر AA", body: { text: "يعرض جزءا من ملف الأحماض الدهنية المرتبط بالتوازن.", verification: "required" } },
    ],
  },
  process: {
    title: "كيف تتم الخطوة من البداية إلى النتيجة",
    steps: [
      { label: "01", title: "تأخذ العينة في البيت", body: { text: "تضع بضع قطرات من الدم على بطاقة الاختبار، حسب التعليمات الموجودة مع العلبة.", verification: "verified" } },
      { label: "02", title: "ترسل العينة", body: { text: "بعد أن تجف العينة، ترسلها في الظرف المرفق.", verification: "verified" } },
      { label: "03", title: "يتم التحليل في أوسلو", body: { text: "تحلل عينة الدم دون إظهار الهوية لدى Vitas، وهو مختبر مستقل حاصل على اعتماد GMP في أوسلو، النرويج.", verification: "verified" } },
      { label: "04", title: "تستلم التقرير ونشرحه لك", body: { text: "تحصل على تقرير يتضمن ستة مؤشرات. إذا كانت المصطلحات غير واضحة، يمكننا شرح النتيجة بهدوء وبطريقة أبسط.", verification: "verified" } },
    ],
  },
  trust: {
    title: "لماذا يمكن الوثوق بهذه الطريقة",
    items: [
      { title: "اختبار منزلي واضح", body: { text: "BalanceTest هو اختبار منزلي يعتمد على بقعة دم مجففة.", verification: "verified" } },
      { title: "عدة مؤشرات في التقرير", body: { text: "التقرير يعرض ستة مؤشرات تساعدك على فهم النتيجة بشكل أفضل.", verification: "verified" } },
      { title: "النتيجة خلال حتى ثلاثة أسابيع", body: { text: "يتم إبلاغ النتائج خلال مدة تصل إلى ثلاثة أسابيع.", verification: "verified" } },
      { title: "لا نعدك بعلاج", body: { text: "هذه صفحة لفهم الاختبار والنتيجة. لا نقدم تشخيصا طبيا ولا نعد بنتائج صحية محددة.", verification: "verified" } },
    ],
  },
  faqTitle: "أسئلة شائعة",
  faq: [
    { question: "ما هو BalanceTest؟", answer: "BalanceTest هو اختبار منزلي يعتمد على بقعة دم مجففة. يقيس 11 حمضا دهنيا ويعرض ستة مؤشرات في التقرير." },
    { question: "هل هذه الصفحة مخصصة للعرب في السويد؟", answer: "نعم. كتبناها للناطقين بالعربية في السويد، بلغة أبسط من النصوص الطبية أو التسويقية المعتادة." },
    { question: "أين يتم تحليل العينة؟", answer: "تحلل العينة دون إظهار الهوية لدى Vitas في أوسلو، وهو مختبر مستقل حاصل على اعتماد GMP." },
    { question: "كم يستغرق الحصول على النتيجة؟", answer: "يتم إبلاغ النتائج خلال مدة تصل إلى ثلاثة أسابيع." },
    { question: "هل يجب أن أفهم كل المصطلحات الطبية؟", answer: "لا. إذا كان شيء غير واضح، يمكنك ترك رسالة وسنشرح لك الخطوة التالية بطريقة هادئة وبسيطة." },
    { question: "هل هذا تشخيص طبي؟", answer: "لا. الاختبار يعطيك قياسا ومعلومات عن توازن الأحماض الدهنية. إذا كانت لديك حالة صحية أو علاج قائم، تحدث دائما مع الرعاية الصحية." },
    { question: "هل يمكنني المتابعة لاحقا؟", answer: "نعم. يمكن إعادة الاختبار بعد 120 يوما ومقارنة القيم." },
  ],
};
